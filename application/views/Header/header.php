...
/img/favicon.ico" />
    ...
    <link href="<?= base_url('bootstrap') ?>
/css/bootstrap.min.css" rel="stylesheet" type="text/css" />
    <link href="<?= base_url('assets') ?>
/css/plugins.css" rel="stylesheet" type="text/css" />
    <link href="<?= base_url('assets') ?>
/css/scrollspyNav.css" rel="stylesheet" type="text/css" />
    <!-- END GLOBAL MANDATORY STYLES -->

    <!--  BEGIN CUSTOM STYLE FILE  -->
    <link href="<?= base_url('assets') ?>
/css/elements/avatar.css" rel="stylesheet" type="text/css" />
                            ...
                            <a class="dropdown-item">
                                <div class="">
                                    <div class="media">
                                        <div class="user-img">
                                            <img src="assets
/img/90x90.jpg" class="img-fluid mr-2" alt="avatar">
                                        </div>
                                        <div class="media-body">
                                            <div class="">
                    ...
                    <div class="dropdown-menu position-absolute" aria-labelledby="userProfileDropdown">
                        <div class="user-profile-section">
                            <div class="media mx-auto">
                                <img src="<?= base_url('assets/img/' . $user['foto_asli']); ?>" class="img-fluid mr-2" alt="avatar">
                                <div class="media-body">
                                    <h5><?= $user['nama']; ?></h5>
