                            ...
                            <div class="chat-system">
                                ...
                                <div class="user-list-box">
                                    ...
                                    <div class="people">
                                        ...
                                        <div class="person border-none" data-chat="person<?= $message->id_chat ?>">
                                            <div class="user-info">
                                                <div class="f-head">
                                                    <img src="<?= base_url('img/90x90.jpg') ?>" alt="avatar">
                                                </div>
                                                <div class="f-body">
                                                    <div class="meta-info">
                                                        <span class="user-name" data-name="<?= $message->nama ?>"><?= $message->nama ?></span>
                                                        <span class="user-meta-time"><?= $message->waktu ?></span>
                                                    </div>
                                                    <span class="preview"><?= $message->pesan ?></span>
                                                </div>
                                            </div>
                                        </div>                                        
                                    </div>
